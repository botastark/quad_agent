...
//     position_GPS = convertECEF2GPS(position_ECEF);
//     return position_GPS;
// }
...
//     const double dt = 0.5;  // time step in seconds
...
int main() {
    ...
    //     //     cout << "i " << i << endl;
    //     //     cout << "t = " << res.t << endl;
    //     //     cout << "res pos gps:" << endl;
    //     //     cout << to_string_with_precision(res.position_gps.latitude) << " " << to_string_with_precision(res.position_gps.longitude) << " " << to_string_with_precision(res.position_gps.altitude) << endl;
